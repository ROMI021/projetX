        ...
        if (!htmlFormFound) {
            ...
            if (htmlResult.success) {
                ...
                if (finalUiRouteUsed) {
                    ...
                    cache[targetBase].routes.login = finalUiRouteUsed;
                    cache[targetBase].authModel = 'login-route-detected';
                    ...
                    broadcastEvent({ origin: 'AUDIT', type: 'info', msg: `[HEAVY ENGINE] Route de login (${finalUiRouteUsed}) sauvegardée dans le cache.` });
                }
